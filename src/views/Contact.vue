<template>
  <div>
    ...
    <div style="margin-bottom:40px;">I'm currently searching for a job.<br/>Feel free to contact me about any opportunity.</div>
    ...
    <ul>
      ...
      <li>
        ...
        <a href="mailto:rodsan2602@gmail.com" target="_blank">rodsan2602@gmail.com</a>
      </li>
      <li>
        <i class="fa fa-linkedin fa-lg fa-fw" style="vertical-align: -5%;"></i>
        <a href="https://www.linkedin.com/in/rodrigo-sanchez-torres/" target="_blank">linkedin.com/in/rodrigo-sanchez-torres</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/rodsan05" target="_blank">github.com/rodsan05</a>
      </li>
      <!-- <li>
